...
We want to protect against unwanted and unexpected data. We should be programming defensively. For example, would it make sense for our app to allow a hotel with an empty name to be created?
